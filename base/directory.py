...
class GlobFilter(base.job.BaseModule):
    ...
    Configuration:
        ...
        - **sorted**: If True, sort alphabetically
        - **reverse**: If True, make the sort alphabetically reversed. Field *sorted='True'* needed.
        - **only_extensions**: None default, a list of extensions that files must have to be yielded.
        - **exclude_extensions**: None default, a list of extensions that files mustn't have to be yielded.
    """
